...
function drawCentroidGuidewire(loc) {
    ...
    radius = circle.radius + RING_OUTTER_RADIUS;
...
function drawRing() {
    ...
    context.arc(circle.x, circle.y,
        circle.radius + RING_OUTTER_RADIUS,
        0, Math.PI * 2, false);
...
function drawRingOuterCircle() {
    ...
    context.beginPath();
    context.arc(circle.x, circle.y, circle.radius + RING_OUTTER_RADIUS, 0, Math.PI * 2, true);
    context.stroke();
}
